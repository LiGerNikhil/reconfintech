...
export default function Privacy() {
  return (
    <>
      <Helmet>
        <title>Privacy Policy — reconfintech.com</title>
        <meta name="description" content="Privacy policy for reconfintech.com. Learn how we collect, use, and protect your personal data." />
      </Helmet>
      ...
      <section className="section-container py-16 md:py-20 lg:py-24">
        <div className="prose prose-sm max-w-3xl text-body sm:prose-base">
          ...
          <p className="mb-6 leading-relaxed">reconfintech.com (&ldquo;we,&rdquo; &ldquo;our,&rdquo; &ldquo;us&rdquo;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.</p>
